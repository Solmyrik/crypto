...
const avatarMenu = document.querySelector('.header__avatar_card');
if (iconMenu) {
   const avatarBody = document.querySelector('.header__avatar');
   avatarBody.addEventListener("click", function (e) {
      // document.body.classList.toggle('_lock');
      avatarBody.classList.toggle('_active');
      avatarMenu.classList.toggle('_active');
   });
}
